...
# Implement your algorithm here to switch all instances of the word 'dog' and the word 'cat'.me
manual = manual.replace('dog', 'Justin')
manual = manual.replace('cat', 'dog')
manual = manual.replace('Justin', 'cat')
